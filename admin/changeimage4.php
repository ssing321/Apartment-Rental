...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['update'])) {
		...
		$sql = "update tblvehicles set Vimage4=$1 where id=$2";
...
?>
	...
	<head>
		...
		<title>Apartment Leasing Portal | Admin Update Image 4</title>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h2 class="page-title">Apartment Image 4 </h2>

							<div class="row">
								<div class="col-md-10">
									<div class="panel panel-default">
										<div class="panel-heading">Apartment Image 4 Details</div>
										<div class="panel-body">
											<form method="post" class="form-horizontal" enctype="multipart/form-data">
												...
												<div class="form-group">
													...
													<?php
													$id = intval($_GET['imgid']);
													$sql = "SELECT Vimage4 from tblvehicles where tblvehicles.id=$1";
													// $query = $dbh->prepare($sql);
													// $query->bindParam(':id', $id, PDO::PARAM_STR);
													// $query->execute();
