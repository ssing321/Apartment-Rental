...
CREATE TABLE admin (
  ...
  updationDate timestamp NOT NULL DEFAULT '2020-01-01 00:00:01' 
) ;
...
CREATE TABLE tblbooking (
  ...
  FromDate varchar DEFAULT NULL,
  ToDate varchar DEFAULT NULL,
  message varchar DEFAULT NULL,
  Status int DEFAULT NULL,
  PostingDate timestamp NOT NULL DEFAULT '2020-01-01 00:00:01'
) ;
...
CREATE TABLE tblbrands (
  ...
  CreationDate timestamp NULL DEFAULT '2020-01-01 00:00:01',
  UpdationDate timestamp NULL DEFAULT '2020-01-01 00:00:01'
) ;
...
CREATE TABLE tblsubscribers (
  id int NOT NULL,
  SubscriberEmail varchar DEFAULT NULL,
  PostingDate timestamp NULL DEFAULT '2020-01-01 00:00:01'
) ;
...
CREATE TABLE tblusers (
  ...
  RegDate timestamp NULL DEFAULT '2020-01-01 00:00:01',
  UpdationDate timestamp NULL DEFAULT '2020-01-01 00:00:01'
) ;
...
CREATE TABLE tblvehicles (
  id int NOT NULL,
  VehiclesTitle varchar DEFAULT NULL,
  VehiclesBrand int DEFAULT NULL,
  VehiclesOverview varchar DEFAULT NULL,
  PricePerDay int DEFAULT NULL,
  FuelType varchar DEFAULT NULL,
  ModelYear int DEFAULT NULL,
  SeatingCapacity int DEFAULT NULL,
  Vimage1 varchar DEFAULT NULL,
  Vimage2 varchar DEFAULT NULL,
  Vimage3 varchar DEFAULT NULL,
  Vimage4 varchar DEFAULT NULL,
  Vimage5 varchar DEFAULT NULL,
  ...
  RegDate timestamp NOT NULL DEFAULT '2020-01-01 00:00:01',
  UpdationDate timestamp NULL DEFAULT '2020-01-01 00:00:01'
) ;
...
--
-- SERIAL for table admin
--
CREATE SEQUENCE id_seq
   OWNED by admin.id;

SELECT SETVAL(pg_get_serial_sequence('admin', 'id'), max(id))
from admin;
...
--
-- SERIAL for table tblbooking
--
CREATE SEQUENCE id_seq1
   OWNED by tblbooking.id;

SELECT SETVAL(pg_get_serial_sequence('tblbooking', 'id'), max(id))
from tblbooking;

ALTER table tblbooking
   alter column id set default nextval('id_seq1');


--
-- SERIAL for table tblbrands
--
CREATE SEQUENCE id_seq2
   OWNED by tblbrands.id;

SELECT SETVAL(pg_get_serial_sequence('tblbrands', 'id'), max(id))
from tblbrands;

ALTER table tblbrands
   alter column id set default nextval('id_seq2');

--
-- SERIAL for table tblcontactusinfo
--
CREATE SEQUENCE id_seq3
   OWNED by tblcontactusinfo.id;

SELECT SETVAL(pg_get_serial_sequence('tblcontactusinfo', 'id'), max(id))
from tblcontactusinfo;

ALTER table tblcontactusinfo
   alter column id set default nextval('id_seq3');

--
-- SERIAL for table tblcontactusquery
--
CREATE SEQUENCE id_seq4
   OWNED by tblcontactusquery.id;

SELECT SETVAL(pg_get_serial_sequence('tblcontactusquery', 'id'), max(id))
from tblcontactusquery;

ALTER table tblcontactusquery
   alter column id set default nextval('id_seq4');

--
-- SERIAL for table tblpages
--
CREATE SEQUENCE id_seq5
   OWNED by tblpages.id;

SELECT SETVAL(pg_get_serial_sequence('tblpages', 'id'), max(id))
from tblpages;

ALTER table tblpages
   alter column id set default nextval('id_seq5');

--
-- SERIAL for table tblusers
--
CREATE SEQUENCE id_seq6
   OWNED by tblusers.id;

SELECT SETVAL(pg_get_serial_sequence('tblusers', 'id'), max(id))
from tblusers;

ALTER table tblusers
   alter column id set default nextval('id_seq6');

--
-- SERIAL for table tblvehicles
--
CREATE SEQUENCE id_seq7
   OWNED by tblvehicles.id;

SELECT SETVAL(pg_get_serial_sequence('tblvehicles', 'id'), max(id))
from tblvehicles;

ALTER table tblvehicles
   alter column id set default nextval('id_seq7');
COMMIT;
