...
SELECT pg_catalog.setval('public.id_seq1', 12, true);
...
SELECT pg_catalog.setval('public.id_seq2', 21, true);
...
SELECT pg_catalog.setval('public.id_seq6', 14, true);
...
SELECT pg_catalog.setval('public.id_seq7', 28, true);
